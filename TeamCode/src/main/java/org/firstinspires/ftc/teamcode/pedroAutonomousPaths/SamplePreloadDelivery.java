...
public class SamplePreloadDelivery extends OpMode {
    ...
    private final Pose scorePose = new Pose(0, 11.464987, Math.toRadians(0));
    private final Pose endPose = new Pose(-4.1618255, 11.464987, Math.toRadians(0)); // 11 to the left
    private final Pose pullForwardsPose = new Pose(23, 11.464987, Math.toRadians(0));
    private final Pose parkPose1 = new Pose(47, 16.560537, Math.toRadians(135));
    private final Pose parkControlPose = new Pose(0, 60, Math.toRadians(135));
    ...
    public void buildPaths() {
       ...
       // driveFarRight.setLinearHeadingInterpolation(startPose.getHeading(), farRightPose.getHeading());
        ...
        parkPath1 = new Path(new BezierCurve(new Point(scorePose), new Point(parkControlPose), new Point(parkPose1)));
