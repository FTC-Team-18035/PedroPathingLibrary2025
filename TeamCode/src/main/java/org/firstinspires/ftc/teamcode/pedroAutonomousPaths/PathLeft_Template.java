...
@Disabled
@Autonomous(name = "Left Template", preselectTeleOp = "TeleOpWithPID")
public class PathLeft_Template extends OpMode {
    // Pedro variables *************************************************************************	
    private Follower follower;
    private Timer pathTimer, actionTimer, opModeTimer;
    private int pathState;
    private final Pose startPose = new Pose(8.6, 88, Math.toRadians(0));
    private final Pose parkingPose = new Pose(63, 95, Math.toRadians(0));
